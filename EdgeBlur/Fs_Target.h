...
//-----------------------------------------------------------------------------------
//Plugin description
#define FS_DESCRIPTION	"Blur the edges of the image"
...
//-----------------------------------------------------------
#define SUPPORT_SMARTFX			//SmartFX+Float_Color対応
//#define NO_USE_FSGRAPHICS	//FsGraphics関係のコードを無効にする
...
//#define FS_OUT_FLAGS	33556036	//パラメータが変動する場合はNON_PARAM_VARYを追加
