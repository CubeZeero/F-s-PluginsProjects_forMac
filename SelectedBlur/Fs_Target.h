...
#define FS_DESCRIPTION	"Blur only pixels near selected colors (CS6 test version)"
...
//#define FS_OUT_FLAGS	33556036	// Draw when output frame changes; NON_PARAM_VARY behaves differently
