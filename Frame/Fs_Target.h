...
#define FS_DESCRIPTION	"Draw a frame"
...
#define FS_OUT_FLAGS	33556032	//�W��16/32bit�Ή�
//#define FS_OUT_FLAGS	33556036	//���t���[���`��
//#define FS_OUT_FLAGS	1600		//8bit����
...
//#define FS_OUT_FLAGS2 134217801	//8Bit�̂�
