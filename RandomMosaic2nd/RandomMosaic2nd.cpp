	...
	PF_LayerDef		*output)
{
	...
	AEFX_CLR_STRUCT(def);
	PF_ADD_SLIDER(	STR_STRENGTH,//�p�����[�^�̖��O
					0, 				//���l���͂���ꍇ�̍ŏ��l
					255,			//���l���͂���ꍇ�̍ő�l
					0,				//�X���C�_�[�̍ŏ��l 
					128,			//�X���C�_�[�̍ő�l
...
{
	PF_Err		err 		= PF_Err_NONE;
	PF_EffectWorld 	*input	=	&params[MY_INPUT]->u.ld;	//���͉摜�̃A�h���X
