	...
	void*			extraP)
{
	...
	suites.ANSICallbacksSuite1()->sprintf( out_data->return_msg, 
		"Hello from RandomMosaic2nd!\r\rEffect: %s\rWorld: %s\r", 
		(char*)in_data->effect_ref, 
		(char*)in_data->pica_basicP->utils_funcs->getenv(in_data->pica_basicP->getenv, "WORLD_NAME"));
	...
	try
	{
		switch (cmd) {
			...
			case PF_Cmd_USER_CHANGED_PARAM:
				err = HandleChangedParam(in_data,out_data,params,output,(PF_UserChangedParamExtra*)extraP);
				break;
