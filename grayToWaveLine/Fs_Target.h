...
#define FS_DESCRIPTION	"Generate wavy lines from grayscale image"
...
#define FS_OUT_FLAGS	33556032	//通常はこれで良い
//#define FS_OUT_FLAGS	33556036	//これを有効にするとパラメータの変化を描画する。NON_PARAM_VARYを追加するとパラメータ変化時に再描画される
